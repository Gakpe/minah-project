	...
	const finishSocialLogin = async () => {
		try {
			...
			localStorage.setItem(
				"userInfo",
				JSON.stringify(result.oauth.userInfo)
			);
		...
		return (
			<div>
				<Modal
					...
					className={
						"w-full h-full rounded-lg items-center flex justify-center"
					}
				>
					<div
						className={
							"flex flex-col items-center justify-center w-full h-fit gap-4 "
						}
					>
