...
const BalanceSection = () => {
  ...
  return (
    <div
      className={
        "bg-[#FAFAFA] shadow-xl  drop-shadow-xl flex flex-col items-center justify-between w-full   h-full  rounded-lg px-7 py-12  "
      }
    >
      <div
        className={
      ...
      >
        ...
        <Button
          className={
            "w-fit h-full text-white backgroundGradient rounded-full hover:border-textOrange"
          }
        >
          Claim MNH
        </Button>
